...
export default function NewMeetingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const meetingTitle =
        title.trim() ||
        `${platformInfo?.label ?? "Meeting"} - ${new Date().toLocaleDateString()}`;
      ...
      if (!scheduledAt) {
        ...
        toast.success(
          `Bot scheduled for ${new Date(scheduledAt).toLocaleString()}`,
        );
      }
    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Submit a meeting link to deploy a recording bot
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Paste your meeting link below. The platform will be detected
            automatically.
          </CardDescription>
        </CardHeader>
            ...
            <div className="flex flex-col gap-2">
              ...
              {platformInfo && (
                <div className="flex items-center gap-2">
                  <platformInfo.icon
                    className={cn("size-4", platformInfo.color)}
                  />
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      value={delayHours}
                      onChange={(e) =>
                        setDelayHours(Number(e.target.value) || 1)
                      }
                      className="w-24"
                    />
